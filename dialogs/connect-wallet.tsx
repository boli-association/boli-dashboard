...
import { AccountStore, getKeplrFromWindow, WalletStatus, AccountWithCosmos } from '@keplr-wallet/stores';
...
const walletList = [
    {
        ...
        logoUrl: '/public/assets/wallet/keplr.png',
        type: 'extension',
    },
    {
        name: 'WalletConnect',
        description: 'Keplr Mobile',
        logoUrl: '/public/assets/wallet/wallet-connect.png',
        type: 'wallet-connect',
    },
];
...
export class ConnectWalletManager {
	...
	constructor(protected readonly chainStore: ChainStore, protected accountStore?: AccountStore<AccountWithCosmos>) {
